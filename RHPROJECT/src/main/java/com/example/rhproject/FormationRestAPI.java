...
public class FormationRestAPI {
    ...
    @PostMapping("/archiver-formations-passees")
    public ResponseEntity<String> archiverFormationsPassees() {
        FormationService.archiverFormationsPassees();
        return ResponseEntity.ok("Archivage des formations passées effectué avec succès.");
    }
